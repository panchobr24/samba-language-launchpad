...
const ScheduleSection = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-brazilian-yellow/20 to-brazilian-green/20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <Card className="bg-gradient-to-br from-brazilian-blue to-brazilian-green text-white shadow-2xl border-2 border-white">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="mt-6 p-4 bg-brazilian-yellow text-brazilian-blue rounded-lg font-bold text-center text-lg font-body">
          ...
          <Card className="bg-gradient-to-br from-brazilian-green to-brazilian-blue text-white shadow-2xl border-2 border-white">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-3 bg-white/20 rounded-lg">
                <p className="font-bold text-sm font-body">{t('schedule.saturday.pavilions')}</p>
              </div>
              <div className="flex items-center gap-3 p-3 bg-white/20 rounded-lg">
                <Utensils className="w-6 h-6 text-brazilian-yellow" />
                <span className="font-bold font-body">
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-brazilian-green to-brazilian-blue text-white px-8 py-4 rounded-full font-bold text-lg inline-block shadow-xl border-2 border-white font-body">
            {t('schedule.tickets')}
          </div>
        </div>
      </div>
